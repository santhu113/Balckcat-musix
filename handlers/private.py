            ...
            [
                [
                    InlineKeyboardButton(
                        "🥀 𝐍𝐀𝐍𝐔 𝐀𝐃𝐃 𝐂𝐇𝐄𝐒𝐔 𝐊𝐎𝐍𝐃𝐈 ✨", url=f"https://t.me/Santhumusicvcplayerbot?startgroup=true")
                    InlineKeyboardButton("😁 𝐎𝐖𝐍𝐄𝐑 😛​​", url=f"https://t.me/santhu_music_bot")
                    InlineKeyboardButton("😇 𝐍𝐄𝐓𝐖𝐎𝐑𝐊 😛​​", url=f"https://t.me/santhuvc")
                ]
