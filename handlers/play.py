...
async def play(_, message: Message):
    ...
    lel = await message.reply("🔎 **ᴀɢᴜ ʀᴀ ɴɪʙʙᴀ sᴏɴɢ ᴘʀᴏᴄᴇss ᴀʏᴛʜᴜɴᴀᴅʜɪ {}...**")
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                try:
                    ...
                    await lel.edit(
                        "<b>ɴᴀɴᴜ ᴀᴅᴍɪɴ ᴄʜᴇʏɪ 💫  ᴍᴀɴᴄʜɪᴠᴀᴅᴜ ❰ ᴍʀ sᴀɴᴛʜᴜ ❱</b>")
                    return
    ...
    try:
        ...
        await lel.edit(
            f"<i>Hey {user.first_name}, 𝐀𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐭 🎸 𝐔𝐬𝐞𝐫𝐁𝐨𝐭 𝐈𝐬 𝐍𝐨𝐭 𝐈𝐧 𝐓𝐡𝐢𝐬 𝐂𝐡𝐚𝐭' 𝐀𝐬𝐤 𝐀𝐝𝐦𝐢𝐧 😎 𝐓𝐨 𝐒𝐞𝐧𝐝 /𝐏𝐥𝐚𝐲 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 😎 𝐅𝐨𝐫 𝐅𝐢𝐫𝐬𝐭 𝐓𝐢𝐦𝐞 𝐓𝐨 𝐀𝐝𝐝 𝐈𝐭 𝐀𝐧𝐲 𝐇𝐞𝐥𝐩 𝐃𝐦 :- ✨ [ᴍʀ.sᴀɴᴛʜᴜ❣️](https://t.me/santhu_music_bot) ❤️🥀 </i>")
        return
    ...
    if audio:
        ...
        if len(message.command) < 2:
            return await lel.edit(
                "✌❤️ ᴜɴᴅᴜ ʀᴀ ɴɪʙʙᴀ 🎸 sᴏɴɢ 🎧 ᴘʀᴏᴄᴇss ᴀʏɪᴛʜᴀɴᴅʜɪ.. [❤️ ᴏᴡɴᴇʀ: @santhu_music_bot**"
            )
        await lel.edit(" 🔍")
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        await message.reply_photo(
            photo="final.png",
            caption="****❰ sᴀɴᴛʜᴜ ❘ ɴᴇᴛᴡᴏʀᴋ 😈 ❱ 𝐒𝐨𝐧𝐠 ❤️ 𝐏𝐨𝐬𝐢𝐭𝐢𝐨𝐧 💫🤟** {}**".format(position),
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="**❰ sᴀɴᴛʜᴜ ❘ ɴᴇᴛᴡᴏʀᴋ 💞 ❱ Now 😄 𝐏𝐥𝐚𝐲𝐢𝐧𝐠 📀 𝐀𝐭 🤟 `{}`... ᴏᴡɴᴇʀ:@santhu_music_bot**".format(
        message.chat.title
        ), )
